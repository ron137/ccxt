...
class bitbay (Exchange):
    ...
    def describe(self):
        return self.deep_extend(super(bitbay, self).describe(), {
            ...
            'markets': {
                ...
                # TODO: Supply right precision and limits to new markets
                'XRP/USD':  {'id': 'XRPUSD', 'symbol': 'XRP/USD', 'base': 'XRP', 'quote': 'USD', 'baseId': 'XRP', 'quoteId': 'USD', 'precision': {'price': 2, 'amount': 8 }, 'limits':{ 'amount': {'min':0.05}, 'cost': {'min':0.00003} }},
                'XRP/EUR':  {'id': 'XRPEUR', 'symbol': 'XRP/EUR', 'base': 'XRP', 'quote': 'EUR', 'baseId': 'XRP', 'quoteId': 'EUR', 'precision': {'price': 2, 'amount': 8 }, 'limits':{ 'amount': {'min':0.05}, 'cost': {'min':0.00003} }},
                'XRP/PLN':  {'id': 'XRPPLN', 'symbol': 'XRP/PLN', 'base': 'XRP', 'quote': 'PLN', 'baseId': 'XRP', 'quoteId': 'PLN', 'precision': {'price': 2, 'amount': 8 }, 'limits':{ 'amount': {'min':0.05}, 'cost': {'min':0.00003} }},
                'XRP/BTC':  {'id': 'XRPBTC', 'symbol': 'XRP/BTC', 'base': 'XRP', 'quote': 'BTC', 'baseId': 'XRP', 'quoteId': 'BTC', 'precision': {'price': 2, 'amount': 8 }, 'limits':{ 'amount': {'min':0.05}, 'cost': {'min':0.00003} }},
                'XIN/USD':  {'id': 'XINUSD', 'symbol': 'XIN/USD', 'base': 'XIN', 'quote': 'USD', 'baseId': 'XIN', 'quoteId': 'USD', 'precision': {'price': 2, 'amount': 8 }, 'limits':{ 'amount': {'min':0.05}, 'cost': {'min':0.00003} }},
                'XIN/EUR':  {'id': 'XINEUR', 'symbol': 'XIN/EUR', 'base': 'XIN', 'quote': 'EUR', 'baseId': 'XIN', 'quoteId': 'EUR', 'precision': {'price': 2, 'amount': 8 }, 'limits':{ 'amount': {'min':0.05}, 'cost': {'min':0.00003} }},
                'XIN/PLN':  {'id': 'XINPLN', 'symbol': 'XIN/PLN', 'base': 'XIN', 'quote': 'PLN', 'baseId': 'XIN', 'quoteId': 'PLN', 'precision': {'price': 2, 'amount': 8 }, 'limits':{ 'amount': {'min':0.05}, 'cost': {'min':0.00003} }},
                'XIN/BTC':  {'id': 'XINBTC', 'symbol': 'XIN/BTC', 'base': 'XIN', 'quote': 'BTC', 'baseId': 'XIN', 'quoteId': 'BTC', 'precision': {'price': 2, 'amount': 8 }, 'limits':{ 'amount': {'min':0.05}, 'cost': {'min':0.00003} }},
            },
            'fees': {
                'trading': {
                    'maker': 0.3 / 100,
    ...
    def fetch_my_trades(self, symbol=None, since=None, limit=None, params={}):
        ...
        transactions = self.privatePostTransactions(self.extend({
            'market': symbol.replace('/', '-').replace('BCH', 'BCC')
        }, params))
        if not transactions:
            return []
        trades = []
