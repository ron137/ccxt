...
const { ArgumentsRequired, ExchangeError, DDoSProtection, OrderNotFound, AuthenticationError, InsufficientFunds, InvalidOrder, InvalidNonce, NotSupported, OnMaintenance } = require ('./base/errors');
