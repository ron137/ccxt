...
module.exports = class exmo extends Exchange {
    describe () {
        return this.deepExtend (super.describe (), {
            'id': 'hotbit',
            'name': 'HOTBIT',
            'countries': [ 'EE', 'HK' ], // Estonia, Hong Kong
            ...
            'urls': {
                ...
                'referral': '',
                'doc': [
                    'https://github.com/hotbitex/hotbit.io-api-docs/blob/master/rest_api_en.md',
                ],
            ...
            'options': {
                'useWebapiForFetchingFees': false, // TODO: figure why HotBit bans us when we try to fetch() their web urls
                'feesAndLimits': {
                    'success': 1,
                    'ctlr': 'feesAndLimits',
                    'error': '',
